...
| Path | exists | notes |
|------|--------|-------|
| `docs/BRANCHING_POLICY.md` | yes | **`master` final**; branch only for true options; keep count low |
| `docs/execution_plan/16_SAFETY_AND_RULES.md` §5b | yes | Binding agent rules |
