#!/bin/bash
#SBATCH --job-name=colide_tcomp_a100
...
#SBATCH --output=/home/user/ibteshamulhaque/colide/benchmarks/results/dicc/framework/torch_compile_a100_%j.out
#SBATCH --error=/home/user/ibteshamulhaque/colide/benchmarks/results/dicc/framework/torch_compile_a100_%j.err
set -Eeuo pipefail
...
$HOME/micromamba/bin/micromamba run -n colide python scripts/benchmark_torch_compile_dicc.py \
  ...
  --output benchmarks/results/dicc/framework/torch_compile_a100.json
